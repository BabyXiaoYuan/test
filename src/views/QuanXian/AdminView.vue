<template id="temp">
  <div>
    ...
    <el-table-column header-align="center"
      align="center" prop='admin_name' label="管理员名称"></el-table-column>
    <el-table-column header-align="center"
      align="center" prop='mobile' label="部门"/>
    <el-table-column header-align="center"
      align="center" prop='department' label="真实姓名"></el-table-column>
    <el-table-column header-align="center"
      align="center" prop='mobile' label="手机号"/>
      <el-table-column header-align="center"
      align="center" prop='email' label="邮箱"/>
      <el-table-column header-align="center"
      align="center" prop='job' label="角色"/>
      <el-table-column header-align="center"
      align="center" prop='job' label="备注"/>
    <el-table-column header-align="center"
...
const getList = async () => {
  const res:any = await adminlist({ page: page.page, pageSize: page.pageSize })
  console.log(res)
